...
public class PeminjamanDana {
	...
	public PeminjamanDana(int id, String noRek, String nama, String jenisIdentitas, String noIdentitas,
			String wargaNegara, String alamat, String noHp, String email, String tempatLahir, String tanggalLahir,
			String jenisKel, String pekerjaan, Double penghasilan, String npwp, String rekomendasiPerusahaan,
			String status, String ahliWaris, String tujuanPenggunaan, Double jumlahPinjam, String lamaPinjam,
